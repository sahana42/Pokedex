    ...
    return (
        <View style={styles.rootContainer}>
            <View style={styles.BackgroundContainer}>
                ...
                <Text style={styles.headerText}>Gastly</Text>
                </View>
                <View style={styles.header1}>
                <Text style={styles.header1}>#092</Text>
                </View>
                </View>
            ...
            <View style={styles.ForegroundContainer}>
                <View>
                <Image source={require('../../assets/images/Gastly.png')} style={styles.images} />
                 </View>
                 <View style={styles.bubble}>
                    <Text style={styles.bubble1}>Ghost</Text>
                 ...
                 <View style={styles.frame}>
                    ...
                    <Text style={styles.kg}>0,1 kg</Text>
                    </View>
                    ...
                    <Text style={styles.kg}>1,3 m</Text>
                    </View>
                    ...
                    <Text style={styles.moves}>Levitate</Text>
                 ...
                 <Text style={styles.contentText}>Born from gases, anyone would faint if engulfed by its gaseous body, which contains poison.
</Text>
                 </View>
